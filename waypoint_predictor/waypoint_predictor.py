...
import torch
import argparse
from dataloader import RGBDepthPano, MyDataLoader
...
def predict_waypoints(args):
    ...
    train_img_dir = './training_data/rgbd_fov90_12/train/*/*.pkl'
    traindataloader = RGBDepthPano(args, train_img_dir, navigability_dict)     
    eval_img_dir = './training_data/rgbd_fov90_12/val_unseen/*/*.pkl'
    ...
    if args.TRAINEVAL == 'train':
        ...
        best_val_1_MyData = {"avg_wayscore": 0.0, "log_string": '', "update":False}
        best_val_2_MyData = {"avg_pred_distance": 10.0, "log_string": '', "update":False}
