...
def main():
    ...
    parser.add_argument(
        "--run-type",
        choices=["train", "eval", "inference", "GT_waypoint_eval", "GT_waypoint_train"],
        required=True,
    ...
    parser.add_argument('--vscode_debug', default=0, type=int)
...
def run_exp(exp_name: str, exp_config: str, 
            run_type: str, opts=None, local_rank=None, vscode_debug=None) -> None:
